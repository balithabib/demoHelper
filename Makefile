...
SDL_LDFLAGS = $(shell sdl2-config --libs) -lSDL2_mixer -lSDL2_image -lfftw3 -lSDL2_ttf -lGL4Dummies
...
SOURCES = audioHelper.c animations.c window.c earth.c credits.c voronoi.c n.c effet.c geom.c
OBJ = $(SOURCES:.c=.o)
