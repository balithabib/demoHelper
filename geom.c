...
/* Dans geom.c */
static void init_geom(void);
static void draw_geom(void);
static void audio_geom(void);
static void quit_geom(void);
...
static void draw_geom(void) {
  ...
  static Uint32 t0 = 0;
  GLfloat dt = 0.0, steps[2] = {1.0f / gl4dpGetWidth(), 1.0f / gl4dpGetHeight()};
